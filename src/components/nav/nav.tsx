...
const Nav = () => {
  ...
  return (
    <nav
      className={` h-[120px] max-md:h-[100px] max-sm:h-[70px] flex  items-center`}
    >
      <div className={` w-full h-full flex items-center`}>
        {/* left_section_start */}
        <div
          className={`${Style.nav_left_corner} h-full bg-[#0C5DB6]  w-3/4 flex items-center`}
        >
          {/* logo_start */}
          <div className=" text-white flex items-center w-fit mx-[5%] max-lg:flex max-lg:gap-[10px]">
            ...
            <svg
              className="h-[32px] max-[1400px]:h-[30px] lg:hidden"
              viewBox="0 0 87 74"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
                d="M65.05 42.94L39.64 73.95L83.54 74C85.93 74 87.24 71.23 85.73 69.39L65.05 42.94Z"
                fill="white"
              />
              <path
                d="M83.57 0.590027L30.62 0.610027C29.78 0.610027 28.98 0.990027 28.44 1.64003L27.37 2.94003L0.64 35.5C0.22 36.01 0.01 36.64 0 37.27C0 37.9 0.22 38.52 0.64 39.04L29.27 73.94H29.31L59.41 37.28L85.75 5.21003C87.26 3.36003 85.95 0.590027 83.57 0.590027Z"
                fill="white"
              />
            </svg>

            <svg
              className=" h-[32px] max-lg:hidden "
              viewBox="0 0 388 74"
              fill="white"
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          <div className=" max-lg:hidden w-full h-full text-white">
            ...
            <div className="border border-b-0 border-r-0 border-blue-500 flex items-center h-2/3">
              <ul
                ...
                className={`px-[3.15%] text-[1rem] flex gap-[32px]`}
              >
                <Link href={"/"}>
        ...
        {/* rigth_section_start */}
        <div
          className={`${Style.nav_right_corner} h-full bg-[#00AEEF] max-lg:bg-[#0C5DB6] max-lg:flex max-lg:items-center w-1/4 max-lg:relative  max-lg:-left-[0.5px] max-sm:w-2/4`}
        >
                ...
                <div className=" h-[43px] max-md:full  flex items-center w-full">
                  <div className=" text-white h-full flex items-center gap-2 pl-2 w-fit">
                    ...
                    <input
                      type="text"
                      name=""
                      className=" border-0 outline-none w-17"
                      placeholder="Search..."
                      id=""
                    />
                  </div>
                  <div
                    className={`${Style.nav_right_corner} cursor-pointer text-[0.875rem] h-full flex items-center justify-center bg-white w-full`}
                  >
      ...
      <div
        ...
        } transition-all lg:hidden  fixed left-0 top-0 right-0 bg-[#0C5DB6] h-[627px] ${
          Style.side_Menu
        }`}
      >
