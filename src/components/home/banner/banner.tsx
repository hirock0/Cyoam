...
const Banner = () => {
  return (
    <div
      className={` px-[5.52%] max-sm:px-[2%]  mx-auto`}
      style={{
        backgroundImage:
          "linear-gradient(rgba(0, 0, 0, 0.04), rgba(0, 0, 0, 0.04)), url('https://i.ibb.co.com/JWjw9ssQ/dots-background.png')",
      }}
    >
      {/* main_start */}
        ...
        <div className=" absolut z-20 top-0 left-0 right-0 bottom-0">
          ...
          <div className=" px-[2%] max-sm:px-[3%] mx-auto  flex max-[1300px]:flex-col pt-[72px] max-md:pt-[40px] max-sm:pt-[32px] pb-[120px] max-md:pb-[100px] max-sm:pb-[80px] ">
            <div className=" w-1/2 max-[1300px]:w-full max-md:w-full">
              ...
              {/* -------------------------------- */}
              <div className={`botton_rigth_corner overflow-hidden md:hidden`}>
                <Image
                  src={
